...
class TronGUI:
    ...
    def __init__(self, game: Tron, bot: Optional[TronBot]=None, game_speed=500, collect_trn_data=False):
    ...
    def restart(self):
        self.game = Tron(2, dimension=10, random_starts=True)
...
if __name__ == "__main__":
    game = Tron(2, dimension=10, random_starts=True)
    ...
    game = TronGUI(game, bot, game_speed=50, collect_trn_data=False)
    game.main()
