...
if __name__ == "__main__":
    ...
    state_dict = torch.load(
        "C://Users//kylan//Documents//code//repos//Tron//python//tasks//2024_12_4_refactor//model_state.pth"
    )
    ...
    state_dict = torch.load(
        "C://Users//kylan//Documents//code//repos//Tron//python//tasks//2024_12_7_optimize//runs//20241207-193229_oldnet_self_train_v1//checkpoints//oldnet_self_train_v1_30.pth"
    )
    torch_model = EvaluationNetConv3OneStride(grid_dim=10)
    torch_model.load_state_dict(state_dict)
    torch_model = torch_model.to(device)
