...
from tron.ai.MINIMAX_ORACLE_SIMUL_MOVES import OracleInfo, GameResult
...
def from_oracle_to_tensor_train_val_split(
    ...
    for gs, oi in oracle_table.items():
        ...
        h0_examples.append(LabeledExample(PovGameState(gs, 0, 1), oi.value))
...
def main():
    ...
    RUN_DESCRIPTION = "nnue_3x3_grid_search_simul_moves"
...
def grid_search(run_dir: Path, _lr, _bs, _adim, _cval, _fcns):
    ...
    DATA_PATH = tron_dir / r"scripts\y2026\m05\oracle_data_simul\3x3.pkl"
