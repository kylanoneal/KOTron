...
if __name__ == "__main__":
    ...
    data_dir = Path("C:/Users/kylan/Documents/code/repos/KOTron/python/scripts/y2025/m05/experiments/runs/20250524-004611_obstacles_v2/game_data")


    data_file_list = sorted(list(data_dir.iterdir()), key=lambda x: int(x.name.split('_')[3]))
