...
def get_neighbors(coordinate, collision_table):
    ...
    for i in range(4):
        ...
        x = coordinate[0] + Tron.DIRECTIONS[i][0]
        y = coordinate[1] + Tron.DIRECTIONS[i][1]
...
def wall_test_case():
    collision_table = Tron.build_collision_table(50)
...
def simple_test_case():
    path = A_Star((0,0), (25, 25), Tron.build_collision_table(50))
    print("path: ", path)
