...
class GameContainer:
    ...
    def __init__(self, game_width: int, game_height: int, game_result: GameResult, positions: list[KOTron]) -> None:
    ...
    def from_json(json_obj: dict, do_validation=True) -> 'GameContainer':
        ...
        return GameContainer(game_width=json_obj['game_width'],
                             ...
                             positions=[KOTron.from_json() for position in json_obj['positions']]
                            )
