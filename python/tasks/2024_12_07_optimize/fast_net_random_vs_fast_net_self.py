...
if __name__ == "__main__":
    ...
    state_dict = torch.load(
        "C://Users//kylan//Documents//code//repos//Tron//python//tasks//2024_12_7_optimize//runs//20241207-124612_fastnet_train_v1//checkpoints//fastnet_train_v1_20.pth"
    )
    ...
    state_dict = torch.load(
        "C://Users//kylan//Documents//code//repos//Tron//python//tasks//2024_12_7_optimize//runs//20241207-174222_fastnet_self_train_v2//checkpoints//fastnet_self_train_v2_20.pth"
    )
    torch_model = FastNet(grid_dim=10)
    torch_model.load_state_dict(state_dict)
    torch_model = torch_model.to(device)
