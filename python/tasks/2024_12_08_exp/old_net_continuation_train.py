...
if __name__ == "__main__":
    ...
    state_dict = torch.load(
        "C:/Users/kylan/Documents/code/repos/Tron/python/tasks/2024_12_8_exp/oldnet_self_train_continuation_v1_680.pth"
    )
    ...
    run_uid = "oldnet_self_train_continuation_v2"
        ...
        for j in tqdm(range(n_games_per_loop)):
            ...
            while game.status == GameStatus.IN_PROGRESS:
                ...
                p1_direction_update = choose_direction_minimax(
                    model, game, player_index=0, opponent_index=1, depth=1
                )

                p2_direction_update = choose_direction_minimax(
                    model, game, player_index=1, opponent_index=0, depth=1
                )
