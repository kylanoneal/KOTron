...
from game.tron import Tron, DirectionUpdate, Direction,Player, GameStatus
...
def cached_next(game: Tron, direction_updates: DirectionUpdate):
    return Tron.next(game, direction_updates)



def normal_next(game: Tron, direction_updates: DirectionUpdate):
    return Tron.next(game, direction_updates)
...
if __name__=="__main__":
    ...
    for i in range(1000):
        ...
        equivalent_game = Tron(num_players=2, num_rows=10, num_cols=10, random_starts=False)
